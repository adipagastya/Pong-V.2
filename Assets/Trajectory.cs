...
public class Trajectory : MonoBehaviour
{
    ...
    void Update()
    {
        // Inisiasi status pantulan lintasan, yang hanya ditampilkan jika lintasan bertumbukan dengan objek tertentu.
        bool drawBallAtCollision = false;

        // Titik tumbuk yang digeser, untuk menggambar ballAtCollision
        ...
        foreach (RaycastHit2D circleCastHit2D in circleCastHit2DArray)
        {
            ...
            // (karena garis lintas digambar dari titik tengah bola)...
            if (circleCastHit2D.collider != null && circleCastHit2D.collider.GetComponent<BallControl>() == null)
            {
                ...
                // yaitu sebuah titik yang di-offset dari titik tumbukan berdasarkan vektor normal titik tersebut sebersar
                // jari-jari bola.
                ...
                // Hanya gambar lintasan satu titik tumbukan, jadi keluar dari loop 
                break;
            }
        }
